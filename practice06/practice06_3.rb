...
password = "Y2hhcXM2YWk="

Mail.defaults do
  delivery_method :smtp, {
    :address => "cgp.miraitsystems.jp",
    :port => 587,
    :user_name => "morimoto.tatsuya002@miraitsystems.jp", 
    :password => "chaqs6ai",
...
mail = Mail.new do
  to 'morimoto.tatsuya002@miraitsystems.jp'
  from 'morimoto.tatsuya002@miraitsystems.jp'
  subject 'test mail'
  body 'test body'
end
